...
<head runat="server">
    <title>Indian Dental Mart | Sign In </title>
				...
				<div class="graphs">
					<div class="sign-in-form">
						<div class="sign-in-form-top">
							<p><span>Sign In as </span> <a href="Default.aspx">Admin</a></p>
						</div>
						<div class="signin">
							
							<div class="log-input">
								<div class="log-input-left">
								   <asp:TextBox ID="txtUsername" runat="server" CssClass="user" Text="Username:" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Username:';}" />
								</div>
							...
							<asp:Button ID="btnSubmit" runat="server" type="submit" Text="Login to your account" />
						</div>
						<div class="new_people">
							<a href="Signup.aspx">New Users..Register Now!</a>
						</div>
					</div>
				</div>
			</div>
