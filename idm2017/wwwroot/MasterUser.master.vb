        ...
        For Each dr1 As Data.DataRow In drCat1
            ...
            If drCat2.Length > 0 Then
                ...
                For Each dr2 As Data.DataRow In drCat2
                    str.Append("<li Class='level1 nav-6-1 first'><a href='ProductsList.aspx.aspx'><span>" & dr2("CategoryName") & "</span></a>")
                    ...
                    If drCat3.Length > 0 Then
                        ...
                        For Each dr3 As Data.DataRow In drCat3
                            str.Append("<li Class='level2 nav-6-1-1 first'><a href='ProductsList.aspx.aspx'><span>" & dr3("CategoryName") & "</span></a>")
                            ...
                            If drCat4.Length > 0 Then
                                ...
                                For Each dr4 As Data.DataRow In drCat4
                                    str.Append("<li Class='level2 nav-6-1-1 first'><a href='ProductsList.aspx.aspx'><span>" & dr4("CategoryName") & "</span></a></li>")
                                Next
                                str.Append("</ul>")
                            End If
                            str.Append("</li>")
