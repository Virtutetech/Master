<%@ Page Title="Products - Indian Dental Mart" Language="VB" MasterPageFile="~/MasterGuest.master" AutoEventWireup="false" CodeFile="ProductsList.aspx.vb" Inherits="ProductsList" %>
                 ...
                 <%-- <div class="ratings">
                  ...
                  <div class="actions">
                    <asp:Button ID="btnCart" runat="server" CssClass="button btn-cart ajx-cart" title="Add to Cart" Text="Add to Cart" OnClick="btnCart_Click" />
                      <asp:Button ID="btnBuy" runat="server" CssClass="button btn-cart ajx-cart" title="Buy" Text="Buy" OnClick="btnBuy_Click" />
                    <span class="add-to-links">
                        <asp:LinkButton ID="lnkbtnWish" runat="server" ToolTip="Add to Wishlist" CssClass="button link-wishlist" OnClick="lnkbtnWish_Click"></asp:LinkButton>
                        </span> </div>
                </div>
              </li>
                            </ItemTemplate>
